(function () {
    $(document).ready(function () {
        ...
        function setupScrollify() {
            $.scrollify({
                section: ".panel-yearbook",
                setHeights: false,
                interstitialSection: ".ybfooter,.ybheader",
                before: function (i, panels) {
                    let ref = panels[i].attr("data-section-name");
                    $(".paginationyb a.active").removeClass("active");
                    $(".paginationyb a[href='#" + ref + "']").addClass("active");
                    $(".paginationyb-xs a.active").removeClass("active");
                    $(".paginationyb-xs a[href='#" + ref + "']").addClass("active");
                }
            });

            $(".paginationyb a").on("click", function () {
                $.scrollify.move($(this).attr("href"));
            });
        }

        function setupCircleAnimations() {
            $(".carousel2-item2-circle").on("mouseenter", function (event) {
                ...
                $($(this).children()[1]).delay(1000).animate({
                    opacity: 1
                }, 500);
            });

            $(".carousel2-item2-circle").on("mouseleave", function (event) {
                event.preventDefault();
                let newValue = "18vh", $this = $(this);
                if ($this.hasClass("circle-25-percent")) {
                    newValue = "15vh";
                } else if ($this.hasClass("circle-27-percent")) {
                    newValue = "12vh"
                }
                $($(this).children()[0]).animate({
        ...
        function setupVideoPlayer() {
            let player;
            $(".carousel5-item1-card-bg, .carousel6-item-card, .case-study-video").on("click", function () {
            ...
            $("#videoModal").on("hide.bs.modal", function (e) {
                player.pause();
                player = null;
                $(".videoplayer-container").empty();
                $(".videoplayer-container").append("<div id='videoPlayer'></div>");
            });
        }

        function setupPartnerAnimations() {
            let inactiveImgs = [
                {
                    height: "54px",
                    width: "54px",
                    src: "Assets/1280/Brand Logos/mag.png"
                },
                {
                    height: "54px",
                    width: "54px",
                    src: "Assets/1280/Brand Logos/mobilityware.png"
                },
                {
                    height: "54px",
                    width: "54px",
                    src: "Assets/1280/Brand Logos/Munkee.png"
                },
                {
                    height: "24px",
                    width: "77px",
                    src: "Assets/1280/Brand Logos/orangendse-studio.png"
                },
                {
                    height: "24px",
                    width: "77px",
                    src: "Assets/1280/Brand Logos/Outfit7.png"
                },
                {
                    height: "46px",
                    width: "42px",
                    src: "Assets/1280/Brand Logos/pinger.png"
                },
                {
                    height: "20px",
                    width: "86px",
                    src: "Assets/1280/Brand Logos/pinsight.png"
                },
                {
                    height: "34px",
                    width: "95px",
                    src: "Assets/1280/Brand Logos/PSafe.png"
                },
                {
                    height: "34px",
                    width: "95px",
                    src: "Assets/1280/Brand Logos/Resignation-media.png"
                },
                {
                    height: "48px",
                    width: "45px",
                    src: "Assets/1280/Brand Logos/rocket-speed.png"
                },
                {
                    height: "25px",
                    width: "98px",
                    src: "Assets/1280/Brand Logos/rockyou.png"
                },
                {
                    height: "27px",
                    width: "84px",
                    src: "Assets/1280/Brand Logos/skout.png"
                },
                {
                    height: "22px",
                    width: "76px",
                    src: "Assets/1280/Brand Logos/Sky-media.png"
                },
                {
                    height: "48px",
                    width: "48px",
                    src: "Assets/1280/Brand Logos/smg.png"
                },
                {
                    height: "19px",
                    width: "62px",
                    src: "Assets/1280/Brand Logos/Spinrilla.png"
                },
                {
                    height: "48px",
                    width: "45px",
                    src: "Assets/1280/Brand Logos/Underarmour.png"
                },
                {
                    height: "48px",
                    width: "45px",
                    src: "Assets/1280/Brand Logos/wattpad.png"
                },
                {
                    height: "48px",
                    width: "45px",
                    src: "Assets/1280/Brand Logos/weheartit.png"
                },
                {
                    height: "48px",
                    width: "45px",
                    src: "Assets/1280/Brand Logos/Zimad.png"
                }];
            let activeImgs = [
                {
                    height: "28px",
                    width: "108px",
                    src: "Assets/1280/Brand Logos/7th-gear.png"
                },
                {
                    height: "21px",
                    width: "121px",
                    src: "Assets/1280/Brand Logos/BB.png"
                },
                {
                    height: "23px",
                    width: "46px",
                    src: "Assets/1280/Brand Logos/detikcom.png"
                },
                {
                    height: "16px",
                    width: "85px",
                    src: "Assets/1280/Brand Logos/EA.png"
                },
                {
                    height: "28px",
                    width: "47px",
                    src: "Assets/1280/Brand Logos/feo.png"
                },
                {
                    height: "24px",
                    width: "106px",
                    src: "Assets/1280/Brand Logos/Fortafy-games.png"
                },
                {
                    height: "26px",
                    width: "112px",
                    src: "Assets/1280/Brand Logos/Gameloft.png"
                },
                {
                    height: "46px",
                    width: "46px",
                    src: "Assets/1280/Brand Logos/Glow-Hockey.jpg"
                },
                {
                    height: "69px",
                    width: "69px",
                    src: "Assets/1280/Brand Logos/handcent.png"
                },
                {
                    height: "22px",
                    width: "98px",
                    src: "Assets/1280/Brand Logos/Harpen.png"
                },
                {
                    height: "24px",
                    width: "77px",
                    src: "Assets/1280/Brand Logos/if-we.png"
                },
                {
                    height: "17px",
                    width: "66px",
                    src: "Assets/1280/Brand Logos/Kiloo.png"
                }];

            let domImgs = $(".img-container-sm-md-lg img");
            callbackFunc();
            function callbackFunc() {
                let randomNo = Math.floor(Math.random() * activeImgs.length);
                setTimeout(function () {
                    $(domImgs[randomNo]).animate({
                        opacity: 0
                    }, 600, function () {
                        let newRandomNo = Math.floor(Math.random() * inactiveImgs.length);
                        let newImg = inactiveImgs[newRandomNo];

                        let oldImg = activeImgs.splice(randomNo, 1, newImg);
                        inactiveImgs.splice(newRandomNo, 1, oldImg[0]);
            ...
            //     var $this = $(this);
            //     if ($this.children(".carousel-inner").children(".item:first").hasClass('active')) {
            //         $this.children('.left.carousel-control').hide();
            //     } else if ($this.children(".carousel-inner").children(".item:last").hasClass('active')) {
...
(function () {
    ...
    generateWorldMap();
    programmaticRisingSvgXs();
    topPerformingVerticalsSvgXs();
    generateWorldMapXs();
    // generateCircles();
    ...
    function topPerformingVerticalsSvgXs() {
        ...
        let data = [
            ...
            { "title": "Retail", "value1": "320", "value2": "235", "text1": "11.7%", "text2": "7.5%" },
            { "title": "CPG", "value1": "480", "value2": "440", "text1": "18.9%", "text2": "16.9%" },
        ];
...
function resetCarousel(){
    ...
    if($( window ).width() <768){
        $(".reflections-bg.dialog.vasuta").addClass("item");
    }
    else{
        $(".reflections-bg.dialog.vasuta").removeClass("item");
